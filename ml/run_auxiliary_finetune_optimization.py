...
desc_str = 'IMDC-multi AUX both-OS'
...
def objective(trial):
    ...
    try:
        ...
        objective1_array = all_metrics['trainrun__val__head_IMDC_MultiClass__on_IMDC ORDINAL_AUROC (ovo, macro)']
        objective2_array = all_metrics['trainrun__val__head_IMDC_MultiClass__on_IMDC ORDINAL_ACC']
