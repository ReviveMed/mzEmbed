...
def fine_tune_cox_model(encoder, X_train, y_duration_train, y_event_train, X_val, y_duration_val, y_event_val, num_epochs=20, batch_size=32, learning_rate=1e-4, dropout=0.2, task_layer_size=128, l1_reg_weight=0.0, l2_reg_weight=0.0, seed=None):
