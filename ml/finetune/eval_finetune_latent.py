...
from finetune.get_finetune_encoder import get_finetune_encoder_from_modelID, get_finetune_input_data


#importing Jonha's funtions 
from models.models import get_model, Binary_Head, Dummy_Head, MultiClass_Head, MultiHead, Regression_Head, Cox_Head, get_encoder
from utils.viz import generate_latent_space, generate_umap_embedding, generate_pca_embedding
...
def evalute_pretrain_latent_survival_tasks( X_data_train, X_data_val, Z_train_real, Z_val_real,Z_train_rand, Z_val_rand, y_data_train, y_data_val, survival_task, survival_event_task):
    ...
    return (best_c_index_Z_real, best_c_index_Z_rand)
...
def main():
    ...
    for pretrain_id, model_info in finetune_dic.items():
        ...
        for survival_task, survival_event_task in zip(task_list_survival[::2], task_list_survival[1::2]):
            ...
            best_c_index_Z_real, best_c_index_Z_rand = evalute_pretrain_latent_survival_tasks(
            ...
            print (f'best_c_index_Z_real: {best_c_index_Z_real}, best_c_index_Z_rand: {best_c_index_Z_rand}')
