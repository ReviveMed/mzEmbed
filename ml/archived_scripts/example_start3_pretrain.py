# example of how to start a pretrain run using setup3.py functions
...
run_id = setup_neptune_run(input_data_dir,
                            ...
                            num_repeats=1, #number of times to repeat the finetune/eval process
                            ...
                            load_encoder_loc= None, #where to load the encoder model from "with_run_id"
                           **kwargs)
