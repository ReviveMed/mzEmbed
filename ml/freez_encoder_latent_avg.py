...
def fine_tune_model(encoder, X_train, y_data_train, X_val, y_data_val, num_classes, num_epochs=20, batch_size=32, learning_rate=1e-4, dropout=0.2, task_layer_size=128, l1_reg_weight=0.0, l2_reg_weight=0.0, latent_passes=10, seed=None):
