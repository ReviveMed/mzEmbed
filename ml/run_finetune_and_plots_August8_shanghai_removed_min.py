        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      neptune_api_token=neptune_api_token,
                                      tags=[
                                          'RCC all studies shanghai removed fine-tune balanced split medium latent size Aug 9'],
...
if __name__ == '__main__':
    ...
    run_id_list = [
        'RCC-7307', 'RCC-7860', 'RCC-7587', 'RCC-7790',
        'RCC-7682', 'RCC-7933', 'RCC-7777', 'RCC-7944',
        'RCC-7930', 'RCC-7804', 'RCC-7994', 'RCC-7975',
        'RCC-7625', 'RCC-7283', 'RCC-7571', 'RCC-7477',
        'RCC-7722'
    ]
