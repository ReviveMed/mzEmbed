# %%
# Combine Autoencoder with Adversarial Network and Classifier Head on the RCC dataset
...
def train_semisupervised(dataloaders,encoder,head,adversary,**kwargs):
    ...
    #############
   # Test the effectiveness of the adversary using an KNeighborsClassifier
    # on the latent space
    ...
    knn = KNeighborsClassifier(n_neighbors=num_classes_gend)
...
output_dir = os.path.join(test_adversarial_dir, 'adversarial_network_Feb21_8')
