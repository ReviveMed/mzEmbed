        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      yes_logging=True,
                                      neptune_api_token=neptune_api_token,
                                      tags=['RCC all studies shanghai removed fine-tune new split large latent size recon only Aug 5'],
...
if __name__ == '__main__':
    ...
    run_id_list = ['RCC-7120', 'RCC-6251', 'RCC-6689', 'RCC-6951', 'RCC-6788', 'RCC-6566']
