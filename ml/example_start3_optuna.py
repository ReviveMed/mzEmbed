# Example of how to run an optuna study to optimize pretraining using the setup3 functions
...
STUDY_DICT = {
    'study_name': 'MultiObj Minimize Example with setup3',
