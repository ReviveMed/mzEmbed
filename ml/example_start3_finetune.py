# Example script for finetuning a model using the functions from setup3.py
...
run_id = setup_neptune_run(input_data_dir,
                            ...
                            num_repeats=5, #number of times to repeat the finetune/eval process. model is only saved at the last iteration
                            ...
                            run_random_init = False, # if true, it will load the model architecture from the run, but random intialize the weights
                           **finetune_kwargs)
