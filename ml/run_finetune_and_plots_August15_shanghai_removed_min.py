...
def main(run_id, yes_plot_latent_space=False, which_finetune_nums=[], task_name_list=[]):
    ...
    if yes_plot_latent_space:
        ...
        plot_latent_space_cols = ['Cohort Label v0', 'Study ID', 'is Pediatric', 'Age', 'Sex', 'BMI']
        _ = setup_neptune_run(input_data_dir,
                              ...
                              yes_logging=True,
                              neptune_api_token=neptune_api_token,
                              tags=['RCC all studies recon only pretrain'],
        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      neptune_api_token=neptune_api_token,
                                      tags=[
                                          'all studies shanghai removed fine-tune segmented Aug 15'],
...
if __name__ == '__main__':
    ...
    run_id_list = [
        "RCC-10687", "RCC-10799", "RCC-11179", "RCC-11016", "RCC-10595", "RCC-10889",
        "RCC-10450", "RCC-10026", "RCC-10175", "RCC-10503", "RCC-10130", "RCC-10164",
        "RCC-9720", "RCC-9775", "RCC-9549", "RCC-9507", "RCC-10673", "RCC-10299",
        "RCC-10305", "RCC-10640", "RCC-10544", "RCC-11144", "RCC-11134", "RCC-8170",
        "RCC-10261", "RCC-9828", "RCC-9053", "RCC-9996", "RCC-10002", "RCC-8981",
        "RCC-9263", "RCC-9204", "RCC-9147", "RCC-9001", "RCC-9889", "RCC-10519",
        "RCC-8871", "RCC-10145", "RCC-8790", "RCC-9909", "RCC-10837", "RCC-8131",
        "RCC-8615", "RCC-10774"
    ]
