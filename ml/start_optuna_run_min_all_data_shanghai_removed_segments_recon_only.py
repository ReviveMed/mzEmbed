...
STUDY_DICT = {
    'study_name': 'RCC all data shanghai removed segmented recon only',
...
def get_study_kwargs(head_kwargs_dict, adv_kwargs_dict,
    ...
    kwargs = make_kwargs_set(encoder_kind=encoder_kind,
                             ...
                             latent_size=None, latent_size_min=latent_size_min, latent_size_max=latent_size_max, latent_size_step=4,
                             ...
                             num_hidden_layers=None, num_hidden_layers_min=num_hidden_layers_min, num_hidden_layers_max=num_hidden_layers_max,
...
if __name__ == '__main__':
    ...
    main(STUDY_DICT, num_trials=50,
         ...
         tag='segmented pretrain shanghai removed recon only Aug 10'
         )
    # 140-160
    main(STUDY_DICT, num_trials=50,
