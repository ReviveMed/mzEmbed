...
def objective(trial):
    ...
    obj_0 = output['end_state_losses']['test']['reconstruction']
    ...
    obj_1 = output['end_state_eval']['test']['head_auc']
    ...
    for n_fold in range(num_folds):
        ...
        res['Val*2 / Train AUC'] = res['Val AUC'] / (res['Train AUC'] / res['Val AUC'])
        results.append(res)

        if NUM_OBJECTIVES==1:
            trial.report(res['Val*2 / Train AUC'], n_fold)
    ...
    return obj_finetune_robust, obj_randinit_val
