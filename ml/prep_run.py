...
def make_kwargs_set(sig_figs=2,
                    ...
                    batch_size=64, batch_size_min=16,batch_size_max=96,batch_size_step=16,
                    noise_factor=0.1, noise_factor_min=0.01, noise_factor_max=0.1, noise_factor_step=0.01,
                    num_epochs=20, num_epochs_min=50, num_epochs_max=300, num_epochs_step=10, num_epochs_log=False,
