        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      neptune_api_token=neptune_api_token,
                                      tags=[
                                          'all studies shanghai removed segmented recon only Aug 15'],
...
if __name__ == '__main__':
    ...
    run_id_list = [
        "RCC-11543", "RCC-10264", "RCC-11419", "RCC-10135", "RCC-11377", "RCC-9948",
        "RCC-11106", "RCC-9808", "RCC-9713", "RCC-11018", "RCC-10795", "RCC-10874",
        "RCC-9695", "RCC-9442", "RCC-10607", "RCC-10480", "RCC-8885", "RCC-8500",
        "RCC-8401", "RCC-10436", "RCC-9226"
    ]
