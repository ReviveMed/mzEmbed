...
STUDY_DICT = {
    'study_name': 'RCC all data shanghai removed balanced split recon only',
...
def get_study_kwargs(head_kwargs_dict, adv_kwargs_dict):
    kwargs = make_kwargs_set(encoder_kind=encoder_kind,
                             ...
                             latent_size=None, latent_size_min=100, latent_size_max=254, latent_size_step=4,
    ...
    def objective(trial):
        ...
        try:
            ...
            run_id = setup_neptune_run(input_data_dir,
                                       ...
                                       yes_logging=True,
                                       neptune_api_token=neptune_api_token,
                                       tags=['RCC all data shanghai removed balanced split medium latent size recon only pretrain'],
