        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      neptune_api_token=neptune_api_token,
                                      tags=[
                                          'all studies fine-tune segmented recon only Aug 15'],
...
if __name__ == '__main__':
    ...
    run_id_list = [
        "RCC-10473", "RCC-10192", "RCC-10343", "RCC-10121", "RCC-9972", "RCC-9785",
        "RCC-9664", "RCC-9566", "RCC-9611", "RCC-9339", "RCC-9178", "RCC-8822",
        "RCC-8904", "RCC-8479", "RCC-8677"
    ]
