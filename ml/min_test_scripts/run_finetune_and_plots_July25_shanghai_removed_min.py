...
def main(run_id, yes_plot_latent_space=False, which_finetune_nums=[], task_name_list=[]):
    ...
    if yes_plot_latent_space:
        ...
        _ = setup_neptune_run(input_data_dir,
                              ...
                              yes_logging=True,
                              neptune_api_token=neptune_api_token,
                              tags=['shanghai (ST002773) removed finetune'],
        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      yes_logging=True,
                                      neptune_api_token=neptune_api_token,
                                      tags=['shanghai (ST002773) removed finetune', setup_num],
...
if __name__ == '__main__':
    ...
    run_id_list = ['RCC-4671', 'RCC-4650', 'RCC-4608', 'RCC-4657', 'RCC-4635', 'RCC-4590',
                   'RCC-4666', 'RCC-4648', 'RCC-4678', 'RCC-4616']
