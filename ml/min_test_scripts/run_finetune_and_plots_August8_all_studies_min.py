        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      yes_logging=True,
                                      neptune_api_token=neptune_api_token,
                                      tags=['RCC all studies fine-tune balanced split medium latent size Aug 9'],
...
if __name__ == '__main__':
    ...
    run_id_list = [
        'RCC-7454', 'RCC-7354', 'RCC-7991', 'RCC-7347', 'RCC-7816',
        'RCC-7950', 'RCC-7719', 'RCC-7922', 'RCC-7948', 'RCC-7470',
        'RCC-7620', 'RCC-7978', 'RCC-8001', 'RCC-7783', 'RCC-7999',
        'RCC-7530', 'RCC-8017', 'RCC-7993', 'RCC-7798', 'RCC-8018',
        'RCC-7821', 'RCC-7851', 'RCC-7889'
    ]
    """
