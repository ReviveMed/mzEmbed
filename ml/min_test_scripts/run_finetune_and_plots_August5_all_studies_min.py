        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      yes_logging=True,
                                      neptune_api_token=neptune_api_token,
                                      tags=['RCC all studies fine-tune new split large latent size Aug 5'],
...
if __name__ == '__main__':
    ...
    run_id_list = ['RCC-5482', 'RCC-6478', 'RCC-7032', 'RCC-6931', 'RCC-6505', 'RCC-7060',
                   'RCC-7069', 'RCC-6605', 'RCC-6475', 'RCC-6294', 'RCC-6681']
    """
