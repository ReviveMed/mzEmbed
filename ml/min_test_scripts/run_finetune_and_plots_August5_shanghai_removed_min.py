        ...
        for finetune_kwargs in finetune_kwargs_list:
            ...
            try:
                _ = setup_neptune_run(input_data_dir,
                                      ...
                                      neptune_api_token=neptune_api_token,
                                      tags=[
                                          'RCC all studies shanghai removed fine-tune new split large latent size Aug 5'],
...
if __name__ == '__main__':
    ...
    run_id_list = ['RCC-6766', 'RCC-6682', 'RCC-7101', 'RCC-6912', 'RCC-6095', 'RCC-7160',
                   'RCC-7191', 'RCC-5474', 'RCC-7150', 'RCC-6813', 'RCC-6253', 'RCC-6277',
                   'RCC-7179', 'RCC-7080']
