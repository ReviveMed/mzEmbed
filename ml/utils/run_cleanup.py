import neptune
from utils.utils_neptune import get_run_id_list, get_run_id_list_from_query
...
rem_fields = ['NIVO-OS weight-5 AND NIVO-PFS weight-5 AND EVER-PFS AND EVER-OS hhl_finetune','NIVO-OS weight-5 AND NIVO-PFS weight-5 AND EVER-PFS AND EVER-OS hhl_randinit',
              'NIVO-PFS AND EVER-PFS','NIVO-OS AND MSKCC_finetune','NIVO-OS AND MSKCC_randinit','NIVO-OS AND MSKCC ADV EVER-OS hhl_finetune',
              'NIVO-OS ADV EVER-OS hhl_randinit','NIVO-OS ADV EVER-OS hhl_finetune']
