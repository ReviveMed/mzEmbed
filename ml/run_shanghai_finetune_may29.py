...
finetune_dir = '/Users/jonaheaton/ReviveMed Dropbox/Jonah Eaton/MS_Data/ST002773_Shanghai_LungCancer'
data_dir = os.path.join(finetune_dir, 'data_v1') 

NEPTUNE_API_TOKEN = 'eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiIxMGM5ZDhiMy1kOTlhLTRlMTAtOGFlYy1hOTQzMDE1YjZlNjcifQ=='
PROJECT_ID = 'revivemed/Survival-RCC'

# desc_str = 'lungcancer v1'
desc_str = 'shanghai cancer v1'
DATE_STR = 'May29'
head_hidden_layers = 0
name = 'basic-R Shanghai opt'
file_suffix = '_shanghai'

study_name = f'{desc_str}_{DATE_STR}'

if not os.path.exists(data_dir):
    home_dir = os.path.expanduser("~")
    data_dir = os.path.join(home_dir, "Shanghai_DATA v1")
    if not os.path.exists(data_dir):
        # synthetic pool data
        dropbox_url = 'https://www.dropbox.com/scl/fo/p6ogbh24zntpnc93dil8v/ALa9A0MJEvKIqB_4ObYYvjE?rlkey=3vbvligufb5pwamr40vdju2hn&dl=1'
...
def objective(trial):
    ...
    obj_clean = 'trainrun__val__head_Cancer__on_Cancer_AUROC (micro)'
