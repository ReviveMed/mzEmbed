...
def run_model_wrapper(data_dir, params, output_dir=None, 
    ...
    #     run_dict[f'{prefix}/model_name'] = 'Model2925'
        ...
        default_params = run_dict['params/fit_kwargs'].fetch()
...
def fit_model_wrapper(X, y, task_components_dict={}, run_dict={}, **fit_kwargs):
    """
    ...
    train_name = fit_kwargs.get('train_name', 'train')
