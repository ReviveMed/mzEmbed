...
# %%
train_select_files = rcc_metadata[(rcc_metadata['study_week'] =='baseline') &
                             (rcc_metadata['phase']==3) &
                             (rcc_metadata[finetune_label_col].isin(['CB','NCB']))
                             ].index.tolist()

test_select_files = rcc_metadata[(rcc_metadata['study_week'] =='baseline') &
