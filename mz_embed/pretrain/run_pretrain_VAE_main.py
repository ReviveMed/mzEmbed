...
def main():
    ...
    for trial in study.trials:
        ...
        model_folder = f'{pretrain_save_dir}/{trial_name}/trial_{trial.number}'
        ...
        if os.path.exists(eval_results_path):
            ...
            eval_results['trial_number'] = trial.number
            ...
            print(f"Warning: {eval_results_path} does not exist for trial {trial.number}")
